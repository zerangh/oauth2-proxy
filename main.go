...
func main() {
	...
	// shutdown through the server and any in-flight requests.
	// personal note: ctx is intentionally declared here so it's easy to pass
	// down to additional components (e.g. background token refresh) later.
